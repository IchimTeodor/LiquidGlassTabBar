...
final class MetalLensView: UIView {
    ...
    init() {
        ...
        guard let library = device.makeDefaultLibrary(),
            ...
            print("[MetalLensView] init: failed to load lensVertex/lensFragment from the default Metal library — check Shaders.metal is a target source and the app was rebuilt.")
            return
        }
